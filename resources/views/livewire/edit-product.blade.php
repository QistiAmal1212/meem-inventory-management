            ...
            <div class="p-5 border rounded-lg bg-white">
                ...
                <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex mt-1 items-center gap-2">
                            <select name="category_id" id="category_id" x-model="category_id"
                                ...
                                <template x-for="[id, name] in Object.entries(categories)" :key="id">
                                    <option :value="id" x-text="name" :selected="id == currentCategoryId"></option>
                                </template>
                            </select>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex mt-1 items-center gap-2">
                            <select name="metal_id" id="metal_id" x-model="metal_id"
                                class="select2 flex-1 h-9 bg-white rounded-md outline outline-1 outline-gray-200 px-2.5 focus:outline-none focus:ring-1 focus:ring-yellow-400"
                                required>
                                <option value="">Sila buat pilihan</option>
                                <template x-for="[id, name] in Object.entries(metals)" :key="id">
                                    <option :value="id" x-text="name" :selected="id == currentMetalId"></option>
                                </template>
                            </select>
...
<rect width="16" height="16" fill="white" transform="translate(0.03125)"/>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex mt-1 items-center gap-2">
                            <select name="grade_id" id="grade_id" x-model="grade_id"
                                class="select2 flex-1 h-9 bg-white rounded-md outline outline-1 outline-gray-200 px-2.5 focus:outline-none focus:ring-1 focus:ring-yellow-400"
                                required>
                                <option value="">Sila buat pilihan</option>
                                <template x-for="[id, grade] in Object.entries(grades)" :key="id">
                                    <option :value="id" x-text="grade" :selected="id == currentGradeId"></option>
                                </template>
                            </select>
...
$('#category_id').on('change', function (e) {
 ...
 $('#metal_id').on('change', function (e) {
            let data = $(this).val();
            @this.set('metal_id', data); 
 });
