         ...
         ">
                <ol class="relative border-s border-gray-200">
                    @foreach($timelines as $item)                  
                        <li class="mb-8 ms-6 group transition ">
                            <!-- Dot -->
                    ...
                    @endforeach
                    <div wire:loading.flex class="justify-center py-4 text-gray-500 text-sm">
                    ...
                    @elseif ($total == 0)
                    <div class="flex items-center justify-center gap-3 py-4 px-6 mx-auto mt-6 text-gray-700 text-base bg-gray-100 rounded-xl border border-gray-200 w-max mb-8">
